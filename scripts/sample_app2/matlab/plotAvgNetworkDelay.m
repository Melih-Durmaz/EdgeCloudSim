function [] = plotAvgNetworkDelay()
    ...
    plotGenericResult(1, 7, {'Average Network Delay';'for Hangar Robots App (sec)'}, app_name_1, '');
    ...
    plotGenericResult(5, 1, {'Average WLAN Delay';'for Hangar Robots App (sec)'}, app_name_1, '');
    ...
    plotGenericResult(5, 2, {'Average MAN Delay';'for Hangar Robots App (sec)'}, app_name_1, '');
    ...
    plotGenericResult(5, 3, {'Average WAN Delay';'for Hangar Robots App (sec)'}, app_name_1, '');
